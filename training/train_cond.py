...
from pytorch_dataset import CustomImageDatasetCond
import pickle
import os
...
def main(args):
    ...
    dataset = CustomImageDatasetCond(annotations_file=args.annotations_file, img_dir=args.img_dir)
    ...
    net = DDPM(channels=3, conditioning=['Input'],conditioning_channels=[6])
